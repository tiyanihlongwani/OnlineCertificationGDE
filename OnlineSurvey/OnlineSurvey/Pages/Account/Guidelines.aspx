<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Guidelines.aspx.cs" Inherits="OnlineSurvey.Pages.Account.guidelines" %>
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-12" style="text-align: right;">
                                            <input type="button" class="btn btn-primary btn-sm" value="Start Survey" />
                                        </div>
                                    </div>
                                </div>
                            </div>
